...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraBridgeViewBase(Context context, AttributeSet attrs) {
        ...
        Log.i(TAG, "Attr count: " + Integer.valueOf(count));
    ...
    public void surfaceChanged(SurfaceHolder arg0, int arg1, int arg2, int arg3) {
        Log.i(TAG, "call surfaceChanged event");
    ...
    private void checkCurrentState() {
        Log.i(TAG, "call checkCurrentState");
        int targetState;
    ...
    private void processEnterState(int state) {
        Log.i(TAG, "call processEnterState: " + state);
        switch(state) {
        case STARTED:
            onEnterStartedState();
            if (mListener != null) {
    ...
    private void processExitState(int state) {
        Log.i(TAG, "call processExitState: " + state);
        switch(state) {
        case STARTED:
            onExitStartedState();
            break;
    ...
    private void onEnterStartedState() {
        Log.i(TAG, "call onEnterStartedState");
        /* Connect camera */
    ...
    protected Size calculateCameraFrameSize(List<?> supportedSizes, ListItemAccessor accessor, int surfaceWidth, int surfaceHeight) {
        ...
        for (Object size : supportedSizes) {
            ...
            Log.i(TAG, "trying size: " + width + "x" + height);
